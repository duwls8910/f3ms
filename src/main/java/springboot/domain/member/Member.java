...
public class Member {
    ...
    @Builder
    public Member(String member_name, Set<MemberIssue> memberIssue,Boolean is_active, Position_cd position_cd, Long number_id, Long main_team_id, Long pre_team_id, LocalDate updated_date){
